  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        className="group w-14 h-14 rounded-full bg-titan-red flex items-center justify-center shadow-lg shadow-titan-red/30 hover:scale-110 hover:shadow-xl hover:shadow-titan-red/40 transition-all duration-300 animate-pulse-glow"
        aria-label="Call us"
      >
